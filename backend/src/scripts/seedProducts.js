...
const productsData = {
    "Urea": ["IPL", "Uttam", "Matrix", "Kisan", "Harul", "Sardar", "KRIBHCO", "RCF", "BBCL"],
    "DAP": ["IPL", "Kisan", "KRIBHCO", "Sardar", "Uttam", "Harul", "PPL", "Paras", "RCF"],
    "MOP (Potash)": ["Matrix", "IPL", "Kisan", "Sardar", "Uttam", "Paras", "Mosaic"],
    "Zinc": ["Paras", "PPL", "Kisan", "Matrix", "BBCL", "Uttam", "IPL"],
    "Boron": ["Paras", "Shriram"],
    "Sulphur": ["Uttam", "Kisan"],
    "Magnesium": ["Uttam", "Harul", "Kisan"],
    "Calcium": ["Mukta", "BBCL", "Harul", "Uttam", "Matrix", "Yara", "Mosaic", "Paras"],
    "NPK": ["Paras", "Kisan", "Uttam", "PPL", "IPL", "Matrix", "Harul", "BBCL", "Mukta"],
    "SSP": ["Paras", "Khaitan", "Harul", "IPL", "PPL"],
    "Polyhalite": ["IPL"],
    "TSP": ["Harul", "PPL", "IPL"],
    "Zyam": ["Paras", "PPL", "Matrix", "Harul", "Uttam", "Kisan"],
    "Apna Power": ["Harul", "Uttam"],
    "Micro Raja": ["PPL"],
