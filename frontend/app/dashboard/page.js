          ...
          <CardContent>
            <div className="grid gap-4 md:grid-cols-3">
              <a href="/billing" className="p-4 border rounded-lg hover:bg-green-50 hover:border-green-600 transition-colors">
                <h3 className="font-semibold text-green-600">Create Bill</h3>
              ...
              <a href="/inventory" className="p-4 border rounded-lg hover:bg-blue-50 hover:border-blue-600 transition-colors">
                <h3 className="font-semibold text-blue-600">Manage Inventory</h3>
                <p className="text-sm text-gray-600 mt-1">Add or update stock</p>
              </a>
              <a href="/customers" className="p-4 border rounded-lg hover:bg-orange-50 hover:border-orange-600 transition-colors">
                <h3 className="font-semibold text-orange-600">Customer Ledger</h3>
                <p className="text-sm text-gray-600 mt-1">View dues and payments</p>
              </a>
            </div>
          </CardContent>
        </Card>
        ...
        {stats.lowStockCount > 0 && (
          <Card className="border-red-200 bg-red-50">
            <CardHeader>
              ...
              <CardDescription>
                {stats.lowStockCount} items are running low. Please restock soon.
              </CardDescription>
            </CardHeader>
          </Card>
        )}
